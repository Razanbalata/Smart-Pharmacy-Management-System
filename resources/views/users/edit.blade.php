...
@section('content')
    <div class="max-w-2xl mx-auto p-6 space-y-6">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-on-surface dark:text-white">Edit Staff Member</h1>
            <p class="text-sm text-on-surface-variant dark:text-gray-400 mt-1">Update account details and modify system
            ...
            <form method="POST" action="{{ route('users.update', $user) }}" class="space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email', $user->email) }}"
                        {{-- يعرض الإيميل الحالي --}} placeholder="name@pharmasmart.com"
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative">
                        <select id="role" name="role"
                            ...
                            required>
                            {{-- يقوم بتحديد الرول الحالية للمستخدم تلقائياً --}}
