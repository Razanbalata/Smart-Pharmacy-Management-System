...
<div class="container mx-auto px-4 py-6 max-w-xl">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800 tracking-wide">Add New Category</h1>
    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
        <form method="POST" action="{{ route('categories.store') }}" class="space-y-5">
            ...
            <div class="flex items-center justify-end gap-3 pt-2 border-t border-gray-100">
                ...
                <button type="submit" class="px-5 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 font-semibold text-white shadow-md transition duration-200 text-sm">
                    Save Category
                </button>
            </div>
        </form>
