        ...
        <div
            ...
            <form method="GET" action="{{ url()->current() }}"
                ...
                <div class="relative sm:col-span-4">
                    <select name="type" class="w-full pl-4 pr-10 py-2 text-sm rounded-xl border">
                    ...
                    <tbody class="divide-y divide-outline-variant/20 text-on-surface dark:text-gray-200 text-sm">
                        @forelse ($movements as $move)
                            <tr
                                ...
                                <td class="px-6 py-4">
                                    <div class="font-semibold text-on-surface dark:text-white">{{ $move->product->name }}
                                    </div>
                                    @if ($move->product->sku)
                                        <div class="text-[11px] font-mono text-gray-400 mt-0.5">SKU:
                                            {{ $move->product->sku }}</div>
                                    @endif
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    @php
                                        ...
                                        $type = $types[$move->type] ?? [
                                            'label' => ucfirst($move->type),
                                            'icon' => 'help',
                                    ...
                                    <span
                                        class="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-bold border {{ $type['class'] }}">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    @endphp
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 rounded-md text-xs font-medium capitalize {{ $reasonClass }}">
                        ...
                        @empty
                            <tr>
                                <td colspan="6"
                                    ...
                                    <span
                                        class="material-symbols-outlined text-4xl block mb-2 text-gray-300">history_toggle_off</span>
