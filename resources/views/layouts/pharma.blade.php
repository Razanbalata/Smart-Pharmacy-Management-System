...
<body class="bg-background text-on-background min-h-screen flex">
    ...
    <aside
        ...
        <div class="flex flex-col p-4 gap-stack-md h-full">
            ...
            <nav class="flex-1 space-y-1">
                <!-- Dashboard Active -->
                <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg border-l-4 border-primary bg-surface-container-low dark:bg-secondary-container/20 text-primary dark:text-primary-container font-semibold transition-colors duration-200"
                    href="#">
                    <span class="material-symbols-outlined">dashboard</span>
                    <span class="font-label-md text-label-md">Dashboard</span>
                </a>
                <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-on-surface-variant dark:text-on-secondary-fixed-variant hover:bg-surface-container dark:hover:bg-on-secondary-fixed-variant/10 transition-colors duration-200"
                    href="#">
            ...
            <div class="mt-auto pt-4 border-t border-outline-variant space-y-1">
                ...
                <div class="mt-4 flex items-center gap-3 px-2">
                    <img class="w-10 h-10 rounded-full bg-surface-container-highest object-cover"
                        data-alt="A professional headshot of a middle-aged male pharmacist with a clean-shaven face and glasses, wearing a white lab coat. He is smiling warmly in a brightly lit, modern clinical environment with soft blue and white background tones. High-end professional photography style, sharp focus, clean corporate aesthetic."
    ...
    <main class="flex-1 flex flex-col h-screen overflow-y-auto scroll-hide">
        <!-- TopNavBar (Authority: JSON & Strategy) -->
        <header
            ...
            <div class="flex justify-between items-center px-gutter w-full max-w-container-max mx-auto h-full">
                <div class="flex items-center gap-4 flex-1">
                    ...
                    <div class="hidden md:flex gap-6 ml-4">
                        <a class="font-body-md text-body-md text-primary font-semibold border-b-2 border-primary pb-1"
    ...
    <script>
        ...
        // Simulating data loading / micro-interactions
